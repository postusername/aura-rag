        ...
        types.Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "space_ids": {"type": "array", "items": {"type": "integer"}, "description": "Kaiten space IDs to include"},
                    "document_group_ids": {"type": "array", "items": {"type": "integer"}, "description": "Kaiten document group IDs to include"},
                    "card_board_ids": {"type": "array", "items": {"type": "integer"}, "description": "Kaiten board IDs whose cards to include"},
                },
        ...
        types.Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "document_group_ids": {"type": "array", "items": {"type": "integer"}},
